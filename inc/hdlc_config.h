...
#define hdlc_output_frame                                               ATC_HDLC_NAME(hdlc_output_frame)
...
#define hdlc_output_packet_start                                        ATC_HDLC_NAME(hdlc_output_packet_start)
#define hdlc_output_packet_information_byte                             ATC_HDLC_NAME(hdlc_output_packet_information_byte)
#define hdlc_output_packet_information_bytes                            ATC_HDLC_NAME(hdlc_output_packet_information_bytes)
#define hdlc_output_packet_end                                          ATC_HDLC_NAME(hdlc_output_packet_end)
#define hdlc_send_ui                                                    ATC_HDLC_NAME(hdlc_send_ui)
