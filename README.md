...
4.  **Initialize the context**:
    ...
    atc_hdlc_init(&ctx,
        ...
        HDLC_DEFAULT_RETRANSMIT_TIMEOUT,        // T1 timeout (default 1000)
        HDLC_DEFAULT_WINDOW_SIZE,               // Window size (1 = Stop-and-Wait)
        HDLC_DEFAULT_ACK_DELAY_TIMEOUT,         // T2 timeout for cumulative ACK (default 10)
        HDLC_DEFAULT_MAX_RETRY_COUNT,           // N2 Retry limit (default 3)
...
| `HDLC_DEFAULT_RETRANSMIT_TIMEOUT` | `1000` | Default T1 retransmission timeout in ticks |
| `HDLC_DEFAULT_ACK_DELAY_TIMEOUT` | `10` | Default T2 ACK delay timeout in ticks for cumulative ACK |
| `HDLC_DEFAULT_CONTENTION_DELAY_TIMEOUT`| `100` | Default contention timer back-off in ticks upon SABM collision |
| `HDLC_DEFAULT_WINDOW_SIZE` | `1` | Default transmit window size for Go-Back-N (1..7) |
| `HDLC_DEFAULT_MAX_RETRY_COUNT` | `3` | Default N2 retry limit before link disconnects |
